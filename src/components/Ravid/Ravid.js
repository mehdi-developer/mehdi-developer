		...
		<Fragment>
			<div className="kkw mb-5">
				<div className="divtext">
					...
					<p style={{ textShadow: '0px 0px 7px #000000' }} className="worktext">
						درج آگهی خرید و فروش راوید
					</p>
					<div className="d-flex justify-content-end">
						<a rel="noopener noreferrer" target="_blank" href="https://ravid-app.github.io">
			...
			<style jsx>
				{`
					...
					.kkw {
						background: url(/static/ravid.jpg) no-repeat;
